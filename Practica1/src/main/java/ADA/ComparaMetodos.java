...
public class ComparaMetodos {
	...
	public static void main(String[] args) {
		int [] tam = {10,50,100,500,1000};//Selecciona tamaños de entrada
		int numPruebas = 4;//Selecciona número de pruebas por tamaño
		String [] competidores = {"N", "LOGN", "N2"};//Selecciona orden de los algoritmos competidores
